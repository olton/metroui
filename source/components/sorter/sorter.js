    ...
    Metro.Component('sorter', {
        ...
        _getItemContent: function(item){
            ...
            if (Metro.utils.isValue(format)) {
                ...
                switch (format) {
                    case "date": data = Metro.utils.isDate(data) ? new Date(data) : ""; break;
                    case "number": data = Number(data); break;
                    case "int": data = Number.parseInt(data); break;
                    case "float": data = Number.parseFloat(data); break;
                    case "money": data = Metro.utils.parseMoney(data); break;
                    case "card": data = Metro.utils.parseCard(data); break;
                    case "phone": data = Metro.utils.parsePhone(data); break;
                }
            }
