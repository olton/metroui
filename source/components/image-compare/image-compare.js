((Metro, $) => {
    ...
    Metro.Component('image-compare', {
        ...
        _createStructure: function(){
            ...
            switch (o.height) {
                case "16/9": element_height = Metro.utils.aspectRatioH(element_width, o.height); break;
                case "21/9": element_height = Metro.utils.aspectRatioH(element_width, o.height); break;
                case "4/3": element_height = Metro.utils.aspectRatioH(element_width, o.height); break;
                case "auto": element_height = Metro.utils.aspectRatioH(element_width, "16/9"); break;
            ...
            const container_overlay = $("<div>").addClass("image-container-overlay").appendTo(element).css({
